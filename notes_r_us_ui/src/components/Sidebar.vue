<template>
    ...
    <nav>
        <RouterLink to="/Upload"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#00000">
                <path
        ...
        <RouterLink to="/Download"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#00000">
                <path
        ...
        <RouterLink to="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#00000">
                <path
