<template>
    ...
    <nav>
        <RouterLink class="route-button" to="/Upload"><svg style="cursor: pointer;" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#00000">
                <path
        ...
        <RouterLink class="route-button"  to="/Download"><svg style="cursor: pointer;" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#00000">
                <path
        ...
        <RouterLink class="route-button" to="#"><svg style="cursor: pointer;" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#00000">
                <path
